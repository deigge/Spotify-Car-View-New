...
function useHistoryListeners(base, historyState, currentLocation, replace) {
	...
	function beforeUnloadListener() {
		if (document.visibilityState === "hidden") {
			...
			history.replaceState(assign$2({}, history.state, { scroll: computeScrollPosition() }), "");
		}
	}
	function destroy() {
...
function useHistoryStateNavigation(base) {
	...
	function replace(to, data) {
		changeLocation(to, assign$2({}, history.state, buildState(historyState.value.back, to, historyState.value.forward, true), data, { position: historyState.value.position }), true);
		currentLocation.value = to;
	}
	function push(to, data) {
		const currentState = assign$2({}, historyState.value, history.state, {
			forward: to,
...
function createRouteRecordMatcher(record, parent, options) {
	const matcher = assign$2(tokensToParser(tokenizePath(record.path), options), {
		record,
		parent,
		children: [],
		alias: []
...
function createRouterMatcher(routes, globalOptions) {
	...
	function resolve(location, currentLocation) {
		...
		if ("name" in location && location.name) {
			...
			params = assign$2(pickParams(currentLocation.params, matcher.keys.filter((k) => !k.optional).concat(matcher.parent ? matcher.parent.keys.filter((k) => k.optional) : []).map((k) => k.name)), location.params && pickParams(location.params, matcher.keys.map((k) => k.name)));
...
function createRouter(options) {
	...
	function resolve(rawLocation, currentLocation) {
		...
		let matcherLocation;
		if (rawLocation.path != null) matcherLocation = assign$2({}, rawLocation, { path: parseURL(parseQuery$1, rawLocation.path, currentLocation.path).path });
		else {
	...
	function pushWithRedirect(to, redirectedFrom) {
		...
		return (failure ? Promise.resolve(failure) : navigate(toLocation, from)).catch((error) => isNavigationFailure(error) ? isNavigationFailure(error, ErrorTypes.NAVIGATION_GUARD_REDIRECT) ? error : markAsReady(error) : triggerError(error, toLocation, from)).then((failure) => {
			if (failure) {
				if (isNavigationFailure(failure, ErrorTypes.NAVIGATION_GUARD_REDIRECT)) return pushWithRedirect(assign$2({ replace }, locationAsObject(failure.to), {
					state: typeof failure.to === "object" ? assign$2({}, data, failure.to.state) : data,
					force
	...
	*/
	function finalizeNavigation(toLocation, from, isPush, replace, data) {
		...
		if (isPush) if (replace || isFirstNavigation) routerHistory.replace(toLocation.fullPath, assign$2({ scroll: isFirstNavigation && state && state.scroll }, data));
...
//#endregion
//#region src/components/NavButton.vue?vue&type=script&setup=true&lang.ts
var NavButton_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	__name: "NavButton",
	props: {
		active: { type: Boolean },
		size: {},
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("button", {
				class: normalizeClass(["nav-btn", { active: __props.active }]),
...
function _sfc_render$16(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$26, [..._cache[0] || (_cache[0] = [
		...
		createBaseVNode("path", { d: "M12 8l0 4l2 2" }, null, -1),
		createBaseVNode("path", { d: "M3.05 11a9 9 0 1 1 .5 4m-.5 5v-5h5" }, null, -1)
	])]);
}
var historyIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$15, [["render", _sfc_render$16]]);
//#endregion
...
function _sfc_render$15(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$25, [..._cache[0] || (_cache[0] = [
		...
		createBaseVNode("path", { d: "M5 12l-2 0l9 -9l9 9l-2 0" }, null, -1),
		createBaseVNode("path", { d: "M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7" }, null, -1),
		createBaseVNode("path", { d: "M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6" }, null, -1)
	])]);
}
var homeIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$14, [["render", _sfc_render$15]]);
//#endregion
...
function _sfc_render$14(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$24, [..._cache[0] || (_cache[0] = [createStaticVNode("<path stroke=\"none\" d=\"M0 0h24v24H0z\" fill=\"none\"></path><path d=\"M11 17a3 3 0 1 0 6 0a3 3 0 1 0 -6 0\"></path><path d=\"M17 17v-13h4\"></path><path d=\"M13 5h-10\"></path><path d=\"M3 9l10 0\"></path><path d=\"M9 13h-6\"></path>", 6)])]);
}
var playlistIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$13, [["render", _sfc_render$14]]);
//#endregion
//#region src/components/BottomNavBar.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1$23 = { class: "bottom-nav" };
//#endregion
...
var BottomNavBar_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("nav", _hoisted_1$23, [
...
var ToastComponent_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({ setup() {
	return {
		message,
		visible,
		type
...
function _sfc_render$13(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createBlock(Transition, { name: "fade" }, {
		default: withCtx(() => [_ctx.visible ? (openBlock(), createElementBlock("div", {
			key: 0,
			class: normalizeClass(["toast", _ctx.type])
...
var _hoisted_1$21 = { class: "track-info" };
var _hoisted_2$6 = { id: "trackArtist" };
//#endregion
//#region src/components/player/TrackInfo.vue
var TrackInfo_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "TrackInfo",
	props: {
		title: {},
		artist: {}
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$21, [createBaseVNode("span", {
				id: "trackTitle",
				ref_key: "titleRef",
				ref: titleRef,
				class: normalizeClass({ scrolling: titleOverflowing.value })
...
var IconButton_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _cache) => {
			...
			}, [renderSlot(_ctx.$slots, "default", {}, void 0, true)], 14, _hoisted_1$20);
		};
	}
...
var playerPlayIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$11, [["render", _sfc_render$11]]);
//#endregion
...
function _sfc_render$10(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$17, [..._cache[0] || (_cache[0] = [
		...
		createBaseVNode("path", { d: "M6 6a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v12a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1l0 -12" }, null, -1),
		createBaseVNode("path", { d: "M14 6a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v12a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1l0 -12" }, null, -1)
	])]);
}
var playerPauseIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$10, [["render", _sfc_render$10]]);
//#endregion
...
function _sfc_render$9(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$16, [..._cache[0] || (_cache[0] = [
		...
		createBaseVNode("path", { d: "M20 5v14l-12 -7l12 -7" }, null, -1),
		createBaseVNode("path", { d: "M4 5l0 14" }, null, -1)
	])]);
}
var playerSkipBackIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$9, [["render", _sfc_render$9]]);
//#endregion
...
function _sfc_render$8(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$15, [..._cache[0] || (_cache[0] = [
		...
		createBaseVNode("path", { d: "M4 5v14l12 -7l-12 -7" }, null, -1),
		createBaseVNode("path", { d: "M20 5l0 14" }, null, -1)
	])]);
}
var playerSkipForwardIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$8, [["render", _sfc_render$8]]);
//#endregion
...
function _sfc_render$7(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$14, [..._cache[0] || (_cache[0] = [
		...
		createBaseVNode("path", { d: "M4 12v-3a3 3 0 0 1 3 -3h13m-3 -3l3 3l-3 3" }, null, -1),
		createBaseVNode("path", { d: "M20 12v3a3 3 0 0 1 -3 3h-13m3 3l-3 -3l3 -3" }, null, -1)
	])]);
}
var repeatIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$7, [["render", _sfc_render$7]]);
//#endregion
...
var repeatOnceIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$6, [["render", _sfc_render$6]]);
//#endregion
...
function _sfc_render$5(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$12, [..._cache[0] || (_cache[0] = [
		...
		createBaseVNode("path", { d: "M4 12v-3c0 -1.336 .873 -2.468 2.08 -2.856m3.92 -.144h10m-3 -3l3 3l-3 3" }, null, -1),
		createBaseVNode("path", { d: "M20 12v3a3 3 0 0 1 -.133 .886m-1.99 1.984a3 3 0 0 1 -.877 .13h-13m3 3l-3 -3l3 -3" }, null, -1),
		createBaseVNode("path", { d: "M3 3l18 18" }, null, -1)
	])]);
}
var repeatOffIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$5, [["render", _sfc_render$5]]);
//#endregion
//#region src/components/player/PlayerControls.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1$11 = { class: "controls" };
var _hoisted_2$5 = {
	class: "controls",
	id: "mainControls"
};
//#endregion
//#region src/components/player/PlayerControls.vue
var PlayerControls_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function togglePlayback() {
			if (props.isPlaying) spotifyApi.spotifyPut("me/player/pause");
			else spotifyApi.spotifyPut("me/player/play");
		}
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [createBaseVNode("div", _hoisted_1$11, [createVNode(IconButton_default, {
				...
				default: withCtx(() => [props.repeatState == "context" ? (openBlock(), createBlock(repeatIcon_default, { key: 0 })) : props.repeatState == "track" ? (openBlock(), createBlock(repeatOnceIcon_default, { key: 1 })) : (openBlock(), createBlock(repeatOffIcon_default, { key: 2 }))]),
				_: 1
				...
				createVNode(IconButton_default, {
					...
					default: withCtx(() => [props.isPlaying ? (openBlock(), createBlock(playerPauseIcon_default, { key: 0 })) : (openBlock(), createBlock(playerPlayIcon_default, { key: 1 }))]),
					_: 1
				}, 8, ["disabled"]),
				createVNode(IconButton_default, {
					size: "3.5rem",
...
var cloudOffIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$4, [["render", _sfc_render$4]]);
//#endregion
//#region src/views/PlayerView.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1$9 = { class: "player-view" };
...
var PlayerView_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const playlistName = /* @__PURE__ */ ref("");
		const albumCover = /* @__PURE__ */ ref(album_cover_placeholder_default);
		...
		function startIntervals() {
			...
			progressInterval = window.setInterval(() => {
				...
				progress.value = (startProgress + elapsed) / currentTrack.item.duration_ms * 100;
			}, 1e3);
			syncInterval = window.setInterval(async () => {
				...
				if (fetchedTrack.item.id !== currentTrackId) {
					...
					const isSaved = spotifyApi.spotifyFetch(`me/tracks/contains?uris=spotify:track:${currentTrack.context?.uri}`);
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$9, [
				createBaseVNode("span", _hoisted_2$4, toDisplayString(playlistName.value), 1),
				createVNode(TrackInfo_default, {
				...
				createVNode(PlayerControls_default, {
					...
					repeatState: repeatState.value,
					disabled: !unref(isOnline)
				}, null, 8, [
					"isPlaying",
					"shuffleState",
					"repeatState",
...
var PlaylistCard_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "PlaylistCard",
	props: {
		coverUrl: {},
		name: {},
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("button", {
				...
				onError: _cache[0] || (_cache[0] = (...args) => unref(onImageError) && unref(onImageError)(...args))
			}, null, 40, _hoisted_2$3), createBaseVNode("span", null, toDisplayString(__props.name), 1)], 8, _hoisted_1$8);
		};
	}
}), [["__scopeId", "data-v-5b262c1a"]]);
//#endregion
//#region src/views/PlaylistView.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1$7 = { class: "playlist-view" };
var _hoisted_2$2 = { class: "playlists-grid" };
//#endregion
//#region src/views/PlaylistView.vue
var PlaylistView_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "PlaylistView",
	setup(__props) {
		const { isOnline } = useOnlineStatus();
		const spotifyApi = useAuthStore();
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$7, [_cache[0] || (_cache[0] = createBaseVNode("h1", { class: "safe-top" }, "My playlists", -1)), createBaseVNode("div", _hoisted_2$2, [(openBlock(true), createElementBlock(Fragment, null, renderList(playlists.value, (playlist) => {
				return openBlock(), createBlock(PlaylistCard_default, {
					key: playlist.id,
...
var shareIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$3, [["render", _sfc_render$3]]);
//#endregion
//#region src/components/icons/heartIcon.vue
var _sfc_main$2 = {};
var _hoisted_1$5 = {
	xmlns: "http://www.w3.org/2000/svg",
	width: "24",
...
function _sfc_render$2(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$5, [..._cache[0] || (_cache[0] = [createBaseVNode("path", {
		...
		d: "M0 0h24v24H0z",
		fill: "none"
	}, null, -1), createBaseVNode("path", { d: "M19.5 12.572l-7.5 7.428l-7.5 -7.428a5 5 0 1 1 7.5 -6.566a5 5 0 1 1 7.5 6.572" }, null, -1)])]);
}
var heartIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$2, [["render", _sfc_render$2]]);
//#endregion
//#region src/components/icons/heartFilledIcon.vue
var _sfc_main$1 = {};
var _hoisted_1$4 = {
	xmlns: "http://www.w3.org/2000/svg",
	width: "24",
...
function _sfc_render$1(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$4, [..._cache[0] || (_cache[0] = [createBaseVNode("path", {
		...
		d: "M0 0h24v24H0z",
		fill: "none"
	}, null, -1), createBaseVNode("path", { d: "M6.979 3.074a6 6 0 0 1 4.988 1.425l.037 .033l.034 -.03a6 6 0 0 1 4.733 -1.44l.246 .036a6 6 0 0 1 3.364 10.008l-.18 .185l-.048 .041l-7.45 7.379a1 1 0 0 1 -1.313 .082l-.094 -.082l-7.493 -7.422a6 6 0 0 1 3.176 -10.215z" }, null, -1)])]);
}
var heartFilledIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main$1, [["render", _sfc_render$1]]);
//#endregion
//#region src/components/TrackCard.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1$3 = { id: "trackCard" };
var _hoisted_2$1 = ["src"];
var _hoisted_3 = { id: "trackInfo" };
var _hoisted_4 = { id: "title" };
var _hoisted_5 = { id: "artist" };
var _hoisted_6 = { id: "buttons" };
//#endregion
//#region src/components/TrackCard.vue
var TrackCard_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "TrackCard",
	props: {
		title: {},
		artist: {},
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [createBaseVNode("div", _hoisted_1$3, [
				...
				createBaseVNode("div", _hoisted_6, [createVNode(IconButton_default, { onClick: share }, {
					...
					_: 1
				}), createVNode(IconButton_default, { disabled: props.disabled }, {
					default: withCtx(() => [props.isSaved ? (openBlock(), createBlock(heartFilledIcon_default, { key: 0 })) : (openBlock(), createBlock(heartIcon_default, { key: 1 }))]),
					_: 1
				}, 8, ["disabled"])])
			]), _cache[1] || (_cache[1] = createBaseVNode("hr", null, null, -1))], 64);
		};
	}
}), [["__scopeId", "data-v-114c6067"]]);
//#endregion
//#region src/views/HistoryView.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1$2 = { id: "history-view" };
var _hoisted_2 = { id: "date-header" };
//#endregion
//#region src/views/HistoryView.vue
var HistoryView_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "HistoryView",
	setup(__props) {
		const { isOnline } = useOnlineStatus();
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$2, [_cache[2] || (_cache[2] = createBaseVNode("h1", { class: "safe-top" }, "History", -1)), (openBlock(true), createElementBlock(Fragment, null, renderList(groupedTracks.value, (songs, date) => {
				return openBlock(), createElementBlock("div", { key: date }, [createBaseVNode("div", _hoisted_2, [
					_cache[0] || (_cache[0] = createBaseVNode("hr", null, null, -1)),
					createBaseVNode("h2", null, toDisplayString(date), 1),
					_cache[1] || (_cache[1] = createBaseVNode("hr", null, null, -1))
				]), (openBlock(true), createElementBlock(Fragment, null, renderList(songs, (track) => {
					return openBlock(), createBlock(TrackCard_default, {
						key: track._id,
						title: track.name,
...
function _sfc_render(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$1, [..._cache[0] || (_cache[0] = [
		...
		createBaseVNode("path", { d: "M12 6h-6a2 2 0 0 0 -2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-6" }, null, -1),
		createBaseVNode("path", { d: "M11 13l9 -9" }, null, -1),
		createBaseVNode("path", { d: "M15 4h5v5" }, null, -1)
	])]);
}
var externalLinkIcon_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["render", _sfc_render]]);
//#endregion
//#region src/views/LoginView.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1 = { id: "login" };
//#endregion
//#region src/views/LoginView.vue
var LoginView_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "LoginView",
	setup(__props) {
		function login() {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [createBaseVNode("button", {
				id: "loginButton",
				onClick: login
			}, [_cache[0] || (_cache[0] = createTextVNode(" Mit Spotify anmelden ", -1)), createVNode(externalLinkIcon_default)])]);
		};
	}
...
var router = createRouter({
	...
	routes: [
		...
		},
		{
			path: "/",
			name: "home",
			component: PlayerView_default
		},
		{
			path: "/playlists",
			name: "Playlists",
			component: PlaylistView_default
		},
		{
			path: "/history",
			name: "History",
			component: HistoryView_default
		},
		{
			path: "/login",
			name: "Login",
			component: LoginView_default
		}
	]
});
